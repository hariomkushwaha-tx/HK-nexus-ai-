...
export const ChatWorkspace: React.FC<ChatWorkspaceProps> = ({ 
  ...
  const getSmartFallbackAnswer = (query: string): string => {
    ...
    if (/और बताओ|और क्या|कैसे हो|क्या हाल|how are you|भाई क्या हो गया/i.test(q)) {
      return `सब एकदम बढ़िया और चालू है भाई! बताइए, क्या प्रश्न या सहायता चाहिए?`;
    }
    ...
    if (/who created you|किसने बनाया|owner|developer|hariom|निर्माता|किसका है|google ne banaya/i.test(q)) {
      return `HK Nexus AI को **हरिओम कुशवाहा (Hariom Kushwaha)** — HK Tech World (मौरानीपुर, झांसी) ने बनाया और विकसित किया है।`;
    }
    if (/क्या क्या कर सकते हो|what can you do|features|capability|क्षमता|काम|कार्य|help me/i.test(q)) {
      return `मैं **HK Nexus AI (v3.6 Pro Ultra)** हूँ और मैं आपके लिए निम्नलिखित सभी कार्य तेज़ी से कर सकता हूँ:

1. 💻 **कोडिंग व सॉफ्टवेयर डेवलपमेंट:** Python, JavaScript, TypeScript, React, Node.js, C++, Java, HTML/CSS, SQL और बग फिक्सिंग।
2. 🌐 **लाइव इंटरनेट सर्च व रिसर्च:** ताज़ा खबरें, करंट अफेयर्स, मौसम, शेयर बाज़ार और विषयों पर गहन विश्लेषण।
3. 📐 **गणित व विज्ञान समाधान:** गणितीय सूत्र, कैलकुलस, भौतिकी/रसायन के न्यूमेरिकल और स्टेप-बाय-स्टेप हल।
4. ✍️ **क्रिएटिव राइटिंग व कंटेंट:** ब्लॉग, निबंध, ईमेल, बिज़नेस प्रपोजल, सोशल मीडिया पोस्ट, शायरी और कविताएँ।
5. 🖼️ **इमेज जनरेशन व विज़न:** AI आर्ट/लोगो जनरेशन और फ़ोटो देखकर टेक्स्ट व डेटा निकालना (OCR/Vision)।
6. 🎙️ **ह्यूमन-लाइक वॉयस व स्पीच:** प्राकृतिक हिंदी व अंग्रेजी आवाज़ में बात करना।

बताइए, आज आप किस चीज़ पर काम करना चाहते हैं?`;
    }
    if (/शायरी|shayari|कविता|poem/i.test(q)) {
      return `पेश है एक खूबसूरत शायरी आपके लिए:\n\n*मंजिलें भी जिद्दी हैं, रास्ते भी जिद्दी हैं,*\n*देखते हैं कल क्या होगा, हौसले भी तो जिद्दी हैं!*\n\nबताइए, कोई और खास विषय पर शायरी चाहिए?`;
    }
    if (/joke|चुटकुला|हंसाओ/i.test(q)) {
      return `😄 **लीजिए एक मज़ेदार चुटकुला:**\n\nटीचर: न्यूटन का नियम बताओ?\nछात्र: सर, जब तक कोई बाहर से धक्का न दे, तब तक आलसी इंसान बिस्तर से नहीं उठता!\nटीचर: बैठ जा बेटा, तूने तो ज़िन्दगी का नियम बता दिया! 😂`;
    }

    return `नमस्ते भाई! मैं आपका प्रश्न **"${query}"** समझ गया हूँ। मैं हमेशा सक्रिय हूँ और आपके हर सवाल का सही उत्तर देने के लिए तैयार हूँ।`;
  };
