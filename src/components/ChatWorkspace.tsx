...
बताइए, आज आप किस चीज़ पर काम करना चाहते हैं?`;
    ...
    return `मैं आपके प्रश्न **"${query}"** का उत्तर तैयार कर रहा हूँ। 

यदि आप तुरंत सुपर-फास्ट और रियल-टाइम वेब उत्तर चाहते हैं, तो आप सीधे ऊपर **Settings (⚙️)** में अपनी निःशुल्क **Groq API Key** या **Gemini Key** भी जोड़ सकते हैं, या पुनः प्रश्न पूछ सकते हैं।`;
  };
